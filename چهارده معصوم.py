...
# st.audio("Aghasi.mp3", format="audio/mpeg", loop=True)
# parameters
CDN_LOCAL = False
...
JSON_PATH = 'چهارده معصوم.json' # example json
...
line2 = 'poets'
about = 'About'
view = st.sidebar.radio("View", (line,line2), index=0) # code

if view == line or line2:
    # render html
